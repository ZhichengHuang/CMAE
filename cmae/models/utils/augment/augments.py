...
import numpy as np
from cmae.registry import BATCH_AUGMENTS
...
class Augments(object):
    ...
    def __init__(self, augments_cfg):
        ...
        self.augments = [BATCH_AUGMENTS.build(cfg) for cfg in augments_cfg]
    ...
    def __call__(self, img, gt_label):
        if self.augments:
            ...
            # aug = np.random.choice(self.augments, p=self.augment_probs)
